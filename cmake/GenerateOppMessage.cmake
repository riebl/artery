...
function(clean_opp_messages)
    execute_process(COMMAND "${OMNETPP_MSGC}" ERROR_VARIABLE output)
    string(REGEX MATCH "Version: [0-9\.]+, build: [^ ,]+" opp_msgc_identifier "${output}")
    if (NOT "${opp_msgc_identifier}" STREQUAL "${OMNETPP_MSGC_IDENTIFIER}")
