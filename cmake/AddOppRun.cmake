...
find_program(OMNETPP_RUN_DEBUG NAMES opp_run_dbg PATHS ${OMNETPP_ROOT}/bin DOC "OMNeT++ opp_run_dbg executable")
    ...
    elseif(${_target_type} STREQUAL "SHARED_LIBRARY")
        ...
        foreach(_interface_library IN LISTS _interface_libraries)
            if(TARGET ${_interface_library})
                get_target_property(_opp_library ${_interface_library} OMNETPP_LIBRARY)
                if(_opp_library)
                    set(_opp_libraries -l $<TARGET_FILE:${_interface_library}> ${_opp_libraries})
                endif()
            endif()
        endforeach()
