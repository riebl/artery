...
void ItsG5Service::indicate(const vanetza::btp::DataIndication& ind, std::unique_ptr<vanetza::UpPacket> raw_packet, NetworkInterface& interface)
{
...
void ItsG5Service::indicate(const vanetza::btp::DataIndication& ind, cPacket* packet, NetworkInterface& interface)
{
	delete packet;
}

void ItsG5Service::request(const vanetza::btp::DataRequestB& req, cPacket* packet, boost::optional<NetworkInterface&> interface)
{
