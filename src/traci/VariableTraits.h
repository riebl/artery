...
VAR_TRAIT(libsumo::VAR_VEHICLE, std::string)
...
VAR_TRAIT(libsumo::VAR_PARKING_STARTING_VEHICLES_IDS, std::vector<std::string>)
VAR_TRAIT(libsumo::VAR_PARKING_ENDING_VEHICLES_IDS, std::vector<std::string>)
